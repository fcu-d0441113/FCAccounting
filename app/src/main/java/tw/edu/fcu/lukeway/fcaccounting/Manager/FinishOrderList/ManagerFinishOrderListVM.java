...
public class ManagerFinishOrderListVM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manager_finish_order_list_vm);
    ...
    private void jsonParse() {
        ...
        String url = "http://10.0.2.2:8888/finishOrderList.php";
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            startActivity(new Intent(ManagerFinishOrderListVM.this, ManagerFinishOrderListVC.class));
                            finish();
