...
public class OrderListViewModel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_list_view_model);
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            startActivity(new Intent(OrderListViewModel.this, OrderListViewController.class));
                            finish();
