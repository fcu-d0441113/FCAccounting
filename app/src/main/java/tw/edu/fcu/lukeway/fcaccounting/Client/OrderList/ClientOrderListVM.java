...
public class ClientOrderListVM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_client_order_list_vm);
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            startActivity(new Intent(ClientOrderListVM.this, ClientOrderListVC.class));
                            finish();
